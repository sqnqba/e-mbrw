...
Revision ID: 3474b21e4c49
Revises:
Create Date: 2024-12-10 17:48:06.314828
...
def upgrade():
    ...
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(length=4096), nullable=False),
